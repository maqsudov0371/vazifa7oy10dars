...
from .views import (HomePageView, RegisterView, LoginView, CourseDetailView,
                    AddCourseView, UpdateCourseView, ServiceView, ServiceDetailView, TeacherView, TeacherDetailView)
...
urlpatterns = [
   ...
   path('teacher/<int:pk>/', TeacherDetailView.as, name='teacher_detail'),
